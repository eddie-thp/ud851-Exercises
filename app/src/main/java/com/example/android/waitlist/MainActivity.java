...
public class MainActivity extends AppCompatActivity {
    ...
    public void addToWaitlist(View view) {
        ...
        String partySizeStr = mNewPartySizeEditText.getText().toString();
        if (TextUtils.isEmpty(guestName) || TextUtils.isEmpty(partySizeStr)) {
            return;
        }
        ...
        try {
            ...
            Log.e(LOG_TAG, "Failed to parse party size", e);
        }
    ...
    void addGuest(final String name, final int partySize) {
