...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChargingIntent = new IntentFilter();
        ...
        mChargingIntent.addAction(Intent.ACTION_POWER_CONNECTED);
        mChargingIntent.addAction(Intent.ACTION_POWER_DISCONNECTED);
    }
    ...
    protected void onResume() {
        super.onResume();
        registerReceiver(mChargingReceiver, mChargingIntent);
    }
    ...
    public void showCharging(final boolean show) {
        if (show) {
            mChargingImageView.setImageDrawable(ResourcesCompat.getDrawable(getResources(), R.drawable.ic_power_pink_80px, getTheme()));
        } else {
            mChargingImageView.setImageDrawable(ResourcesCompat.getDrawable(getResources(), R.drawable.ic_power_grey_80px, getTheme()));
        }
    }
    ...
    class ChargingBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            boolean charging = Intent.ACTION_POWER_CONNECTED == intent.getAction();
