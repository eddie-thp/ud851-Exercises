...
public class NotificationUtils {
    ...
    public static Action ignoreReminderAction(Context context) {
        ...
        Intent startWaterReminderServiceIntent = new Intent(context, WaterReminderIntentService.class);
        //      COMPLETED (7) Set the action of the intent to designate you want to dismiss the notification
        startWaterReminderServiceIntent.setAction(ReminderTasks.ACTION_DISMISS_NOTIFICATION);


        //      COMPLETED (8) Create a PendingIntent from the intent to launch WaterReminderIntentService
        PendingIntent ignoreNotificationIntent = PendingIntent.getService(context, 10, startWaterReminderServiceIntent, PendingIntent.FLAG_UPDATE_CURRENT);
        //      COMPLETED (9) Create an Action for the user to ignore the notification (and dismiss it)
        //      COMPLETED (10) Return the action
        return new Action(R.drawable.ic_cancel_black_24px, "I don't think so", ignoreNotificationIntent);
    ...
    public static Action drinkWaterAction(Context context) {
        ...
        startWaterReminderServiceIntent.setAction(ReminderTasks.ACTION_INCREMENT_WATER_COUNT);

        //      COMPLETED (14) Create a PendingIntent from the intent to launch WaterReminderIntentService
        PendingIntent incrementWaterIntent = PendingIntent.getService(context, 11, startWaterReminderServiceIntent, PendingIntent.FLAG_UPDATE_CURRENT);
        //      COMPLETED (15) Create an Action for the user to tell us they've had a glass of water
        //      COMPLETED (16) Return the action
        return new Action(R.drawable.ic_local_drink_black_24px, "Drinking !", incrementWaterIntent);
    }
