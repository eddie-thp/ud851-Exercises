...
public class ReminderUtilities {
    ...
    private static final int REMINTER_INTERVAL_MINUTES = 15;
    private static final int REMINTER_INTERVAL_SECONDS = (int) (TimeUnit.MINUTES.toSeconds(REMINTER_INTERVAL_MINUTES));
    private static final int SYNC_FLEXTIMES_SECONDS = REMINTER_INTERVAL_SECONDS;
    ...
    public static synchronized void scheduleChargingReminder(@NonNull final Context context) {
        ...
        // COMPLTED (18) Create a new GooglePlayDriver
        Driver driver = new GooglePlayDriver(context);

        // COMPLTED (19) Create a new FirebaseJobDispatcher with the driver
        ...
        Job contraintReminderJob = dispatcher.newJobBuilder()
                ...
                .setRecurring(true)
                .setTrigger(Trigger.executionWindow( REMINTER_INTERVAL_SECONDS, REMINTER_INTERVAL_SECONDS + SYNC_FLEXTIMES_SECONDS))
